...
const timezones = [
    ...
    { label: '(GMT-11:00) Samoa', value: 'US/Samoa' },
    { label: '(GMT-10:00) Hawaii', value: 'US/Hawaii' },
    { label: '(GMT-09:00) Alaska', value: 'US/Alaska' },
    { label: '(GMT-08:00) Pacific Time (US & Canada)', value: 'US/Pacific' },
    ...
    { label: '(GMT-02:00) Stanley', value: 'Atlantic/Stanley' },
    { label: '(GMT-01:00) Azores', value: 'Atlantic/Azores' },
    { label: '(GMT-01:00) Cape Verde Is.', value: 'Atlantic/Cape_Verde' },
    { label: '(GMT) Casablanca', value: 'Africa/Casablanca' },
    { label: '(GMT) Dublin', value: 'Europe/Dublin' },
    { label: '(GMT) Lisbon', value: 'Europe/Lisbon' },
    ...
    { label: '(GMT+04:00) Volgograd', value: 'Europe/Volgograd' },
...
<template>
    ...
    <FormKit
        ...
        name="calorie_unit"
        placeholder="Select a calorie unit"
        :options="calorieUnits"
    />
</template>
