...
<template>
    <aside class="flex h-full">
        <div class="flex w-full flex-col">
            ...
            <div class="ml-5 flex flex-col border-l border-gray-300 pl-6 dark:border-gray-700">
                <Link
                    class="flex items-center justify-start gap-5 rounded-md p-2 text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800"
