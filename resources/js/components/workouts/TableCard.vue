...
import WorkoutTable from '@/components/workouts/Table.vue';
import { WorkoutCollection } from '@/components/workouts/workout';
    ...
    <UiCard>
        <template #header>
            <Header title="workouts">
                <Link :href="route('health.workouts.create')">
                    <UiButton icon="lucide-plus">New</UiButton>
                </Link>
            </Header>
        </template>
        <WorkoutTable :collection="collection" />
        <template #footer>
