...
return new class extends Migration
{
    ...
    {
        Schema::create(config('health.table_prefix').'exercise_muscle_groups', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists(config('health.table_prefix').'exercise_muscle_groups');
    }
};
